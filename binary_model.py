...
def run_one_sample(seq_list, freq_list, seq_model, k_model, e_model, top_n=50, is_gpu=False):
    ...
    test_out_s, semi_outs = seq_model(test_x_b)
    test_out_k, semi_outk = k_model(test_x_k)
...
def bina_run(sample_dict, is_gpu=False):
    ...
    for k, v in sample_dict.items():
        ...
        weight_score, high_idx = run_one_sample(seq_list, freq_list, best_seq_model, best_k_model, best_e_model)
